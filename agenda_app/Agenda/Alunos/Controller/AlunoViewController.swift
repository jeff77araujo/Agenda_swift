...
class AlunoViewController: UIViewController, ImagePickerFotoSelecionadaDelegate {
    ...
    func criaDicionarioParametros() -> [String:String] {
        var id = ""
    ...
    @IBAction func buttonSalvar(_ sender: UIButton) {
        let json = criaDicionarioParametros()
        Repository().salvarAluno(aluno: json)
